...
/*
|--------------------------------------------------------------------------
| Connect kütüphanesi dil dosyası
| Language : 	Türkçe
| Translater :	İskender TOTOĞLU / ALTI VE BİR BİLİŞİM TEKNOLOJİLERİ / http://www.altivebir.com.tr
|
| Bu dil dosyası tema içerisindeki dil dosyası ile değiştirilebilir.
| Basit bir şekilde bu dosyayı /themes/your_theme/language/xx/ klasörüne kopyalayın
| ve çeviri öğelerini düzenleyin.
|
|--------------------------------------------------------------------------
*/
// Kütüphane ana çeviri öğeleri
...
// Yöneticiye gönderilecek Aktivasyon e-postası
...
// Kullanıcıya gönderilecek Aktivasyon e-postası
...
// Kullanıcıya gönderilecek Kayıt Onay e-postası
