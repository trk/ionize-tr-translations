...
/*
|--------------------------------------------------------------------------
| Ionize Yönetim Paneli Dil Dosyası
|--------------------------------------------------------------------------
|
| Language : 	Türkçe
...
|--------------------------------------------------------------------------
*/
$lang['ionize_administration'] = 'Yönetim Paneli';
...
$lang['ionize_dashboard_icon_google_analytics'] = 'Google Analytics';
$lang['ionize_dashboard_icon_articles'] = 'Makaleler';
$lang['ionize_dashboard_icon_users'] = 'Kullanıcılar ve Roller';
...
$lang['ionize_menu_categories'] = 'Kategoriler';
$lang['ionize_menu_types'] = 'Makale Tipleri';
...
$lang['ionize_menu_medialist'] = 'Medya Listesi';
...
$lang['ionize_title_setup'] = 'Kurulum';
$lang['ionize_title_attributes'] = 'Öznitelikler';
$lang['ionize_title_operation'] = 'Operasyonlar';
...
$lang['ionize_title_create_menu'] = 'Menü Oluştur';
$lang['ionize_button_save_new_menu'] = 'Menüyü Kaydet';
$lang['ionize_button_create_menu'] = 'Menü Oluştur';
...
$lang['ionize_label_element_add_field'] = 'Aln Ekle';
...
$lang['ionize_message_element_copied'] = 'Element kopyalandı !';
...
$lang['ionize_message_element_in_use'] = 'Bu element veya alt alanları kullanımda ve silinemez.';

$lang['ionize_message_element_cannot_be_added_to_parent'] = 'Element alt öğe olarak eklenemedi !';
...
/*
|--------------------------------------------------------------------------
| Global form etiketleri & yardım
| Etiketler tablo başlıkları için de kullanılabilirler
|--------------------------------------------------------------------------
*/
$lang['ionize_label_yes'] = 'Evet';
$lang['ionize_label_no'] = 'Hayır';
$lang['ionize_label_change'] = 'Değiştir';
$lang['ionize_label_multilingual'] = 'Çoklu Dil';
...
$lang['ionize_label_select_files_to_upload'] = 'Yüklemek istediğiniz dosyaları seçin';
$lang['ionize_label_select_file'] = 'Dosyayı Seç';
...
$lang['ionize_label_site_email'] = 'Site E-Postası';
$lang['ionize_label_email_technical'] = 'Teknik E-posta';
$lang['ionize_label_email_contact'] = 'İletişim E-posta';
$lang['ionize_label_email_info'] = 'Bilgi E-posta';
...
$lang['ionize_label_full_url'] = 'Tam Bağlantı';
...
$lang['ionize_label_page_single_view'] = 'Tek Görünüm';
...
$lang['ionize_label_summary'] = 'Özet';
...
$lang['ionize_label_has_url'] = 'URL var';
...
$lang['ionize_label_created'] = 'Oluşturulma';
$lang['ionize_label_updated'] = 'Güncelleme';
...
$lang['ionize_label_options'] = 'Seçenekler';
$lang['ionize_label_tracker_edited_by'] = 'Tarafından düzenlendi';
$lang['ionize_label_tracker_status_sleeping'] = 'Beklemede...';
$lang['ionize_label_copy_to_other_languages'] = 'Diğer dillere kopyala';
$lang['ionize_label_nb_per_page'] = 'No / listeleme';
$lang['ionize_help_has_url'] = 'Eğer işaretliyse, element bir URL ye sahip olacak ve bu URL den erişilebilir olacak.';
...
$lang['ionize_help_duplicate_article'] = '<b class="required">İsim</b> alanı makale için benzersiz olması gerektiği için en azından <b class="required">İsim</b> bölümünü değiştirmeniz gerekiyor.';
$lang['ionize_help_environment'] = 'Index.php de belirtilen ENVIRONMENT sabit.';
$lang['ionize_help_environment_flag'] = 'Index.php de <b>ENVIRONMENT</b> sabit olarak görünüyor <b>%s</b>.<br/>Yayına sokmadan önce, <b>production</b> olarak değiştirin.';
$lang['ionize_description_flags'] = 'Bu renk etiketleri makale tipleri tarafından kullanılır, renkli etiketler kullanarak makale tipini anlamanız için kendinize görsel bir yardım oluşturabilirsiniz.<br/>';
$lang['ionize_help_site_email'] = 'İnternet sitesinden gönderilecek tüm e-postalara gönderici olarak bu e-posta adresi eklenecek. Genellikle buna no-reply@internet-sitem.tld benzer e-posta adresleri kullanılır.';
$lang['ionize_help_email_technical'] = 'İnternet sitesi yönetici e-posta adresi';
$lang['ionize_help_email_contact'] = 'Genel iletişim e-posta adresi. İletişim benzeri formlar bu e-posta adresini kullanabilir.';
$lang['ionize_help_email_info'] = 'Bilgi e-posta adresi';
...
$lang['ionize_button_save_all'] = 'Hepsini Kaydet';
$lang['ionize_button_save_close'] = 'Kaydet & Kapat';
$lang['ionize_button_update'] = 'Güncelle';
...
$lang['ionize_button_reset_filter'] = 'Sıfırla';
...
$lang['ionize_button_start_upload'] = 'Yüklemeyi Başlat';
/*
|--------------------------------------------------------------------------
| Genel Meşajlar
|--------------------------------------------------------------------------
...
$lang['ionize_message_form_validation_error'] = 'Bazı veriler bulunamıyor yada yanlış';
$lang['ionize_message_form_validation_please_correct'] = 'Lütfen form verilerini doğrulayın';
$lang['ionize_message_unsaved_element_quit'] = 'Öge değiştirildi fakat kayıt edilmedi. Ayrılmak istediğinizden eminmisiniz ?';
/*
|--------------------------------------------------------------------------
| Yönetici : Dil
|--------------------------------------------------------------------------
...
$lang['ionize_label_force_lang_urls'] = 'Dil kodunu herzaman bağlantılarda kullan';
...
$lang['ionize_label_lang_direction'] = 'Yön';
$lang['ionize_label_lang_direction_ltr'] = 'Soldan Sağa';
$lang['ionize_label_lang_direction_rtl'] = 'Sağdan Sola';
...
$lang['ionize_text_clean_lang_tables'] = 'Var olmayan dil verilerini temizle';
...
$lang['ionize_title_existing_powerusers'] = 'Güçlü Kullanıcılar';
...
$lang['ionize_label_firstname'] = 'Ad';
$lang['ionize_label_lastname'] = 'Soyad';
...
$lang['ionize_message_user_not_deleted'] = 'Kullanıcı silinemedi';
...
$lang['ionize_title_dashboard'] =  'Panel';
...
$lang['ionize_label_display_dashboard_shortcuts'] = 'Kısayollar';
$lang['ionize_help_display_dashboard_shortcuts'] = 'Kısayol Simgelerini Panelde görüntüle';
$lang['ionize_label_display_dashboard_modules'] = 'Modüller';
$lang['ionize_help_display_dashboard_modules'] = 'Yüklü bodül simgelerini Panelde görüntüle';
$lang['ionize_label_display_dashboard_users'] = 'Kullanıcılar';
$lang['ionize_help_display_dashboard_users'] = 'Son giriş yapan ve son kayıt olan kullanıcıları Panelde görüntüle';
$lang['ionize_label_display_dashboard_content'] = 'İçerik';
$lang['ionize_help_display_dashboard_content'] = 'Son düzenlenen makaleleri, yetim sayfalar ve makaleleri görüntüle';
$lang['ionize_label_enable_backend_tracker'] = 'Yönetim Paneli takipçici';
$lang['ionize_help_enable_backend_tracker'] = 'Panelde yönetim paneline bağlı olan kullanıcıları görüntüle / Eğer aynı içeriği başka bir kullanıcı düzenliyor ise uyarı bayrağı görüntüle.';
...
$lang['ionize_help_display_google'] = 'Basit Google Analytics verilerini panelde görüntüle';
/*
|--------------------------------------------------------------------------
| Yönetici : Teknik Ayarlar
|--------------------------------------------------------------------------
*/
...
$lang['ionize_title_mail_send'] = 'E-posta Gönderimi';
$lang['ionize_title_emails'] = 'E-postalar';
$lang['ionize_title_email_server'] = 'E-posta Serverı';
...
$lang['ionize_title_no_source_picture'] = 'Resim kaynağı yoksa';
$lang['ionize_label_article_allowed_tags'] = 'İzin Verilen Taglar';
$lang['ionize_title_seo'] = 'SEO';
$lang['ionize_title_permalink_ping_server'] = 'Permalink ping sunucuları';
$lang['ionize_title_sitemap_search_engine'] = 'Arama Motorları Site Haritası Ping Sunucuları';
$lang['ionize_title_system'] = 'Sistem';
$lang['ionize_title_api'] = 'API';
$lang['ionize_title_create_new_api_key'] = 'API Anahtarı Oluştur';
$lang['ionize_label_create_new_api_key'] = 'Yeni Bir Api Anahtarı Oluştur';
$lang['ionize_button_new_api_key'] = 'Yeni API anahtarı';
$lang['ionize_title_db_backup'] = 'Veritabanı Yedekleme';
...
$lang['ionize_message_error_maintenance_ip_required'] = 'Bakım sayfası için ip adresi girilmesi zorunludur!';
...
$lang['ionize_label_upload_mode'] = 'Yükleme Modu';
...
$lang['ionize_label_google_analytics_id'] = 'Google Takip ID\'si';
$lang['ionize_label_google_analytics_tracking_code'] = 'Google Takip Kodu';
$lang['ionize_label_google_analytics_profile_id'] = 'Google Analytics Profil ID\'si';
$lang['ionize_label_google_analytics_url'] = 'Google Analytics Bağlantısı';
$lang['ionize_label_google_analytics_email'] = 'Google Analytics E-posta Adresi';
$lang['ionize_label_google_analytics_password'] = 'Google Analytics Parolası';
$lang['ionize_label_tinybuttons'] = 'TinyMCE Araç Çubuğu';
$lang['ionize_label_small_tinybuttons'] = 'TinyMCE küçük araç çubuğu';
$lang['ionize_label_restore_tinybuttons'] = 'TinyMCE varsayılan araç çubuğu';
$lang['ionize_label_help_tinybuttons'] = 'TinyMCE araç çubuğu tuşları yardım';
$lang['ionize_label_tinybuttons'] = 'TinyMCE Araç Çubuğu';
...
$lang['ionize_label_db_backup'] = 'Veritabanı yedeğini al';
...
$lang['ionize_label_smtp_timeout'] = 'SMTP Geçikme Süresi';
...
$lang['ionize_label_setting_resize_on_upload'] = 'Yüklerken yeniden boyutlandır';
$lang['ionize_label_setting_upload_autostart'] = 'Yüklemeyi otomatik başlat';
...
$lang['ionize_label_upload_mode'] = 'Yükleme Modu';
$lang['ionize_label_upload_mode_auto'] = 'Otomatik Belirle';
$lang['ionize_label_upload_mode_html4'] = 'HTML4';
$lang['ionize_label_upload_mode_html5'] = 'HTML5';
$lang['ionize_label_media_upload_mode_single'] = 'Tek Dosya';
$lang['ionize_label_media_upload_mode_multiple'] = 'Çoklu Dosya';
$lang['ionize_label_no_source_picture'] = 'Dosya adı';
$lang['ionize_button_update_thumbs'] = 'Varolan küçük resimleri yükle';
...
$lang['ionize_title_keys'] = 'Anahtarlar';
...
$lang['ionize_help_setting_google_analytics'] = 'Google Analytics sayfasından kopyalanan komple Google scripti. Eğer takip ID\'nizi girdiyseniz, bu alanı boş bırakabilirsiniz.';
$lang['ionize_help_setting_google_analytics_id'] = 'Google Analytics Takip ID\'si. Örn. UA-1234567-00';
$lang['ionize_help_setting_google_analytics_profile_id'] = 'Profil ID\'si. Örn. 12345678. Google Analytics profil ayarlarında bulabilirsiniz';
$lang['ionize_help_setting_google_analytics_url'] = 'Google Analytics belirtiğiniz internet siteninizin bağlantı adresi';

$lang['ionize_help_setting_google_analytics_email'] = 'Google Analytics hesabına ait e-posta adresi';
$lang['ionize_help_setting_google_analytics_password'] = 'Google Analytics parolası';
...
$lang['ionize_help_media_upload_mode'] = 'Eğer çoklu dosya yükleme hata verirse, (Flashsız) Tek dosya yüklemeyi deneyin';
$lang['ionize_text_no_thumbnails'] = 'Küçük resimler henüz tanımlanmamış';
$lang['ionize_text_allowed_mimes'] = 'İşaretlediğiniz dosya türleri yüklenebilir olacak.';
$lang['ionize_text_no_source_picture'] = 'Bu resim eklenen medyanın kaynak bağlantısında bir problem olursa kullanılacak.<br/>Dosya adı ve dosya uzantısı ile (dosya.jpg).';
$lang['ionize_help_upload_mode_auto'] = 'Tarayıcıya göre yükleme metodu belirle';
$lang['ionize_help_upload_mode_html4'] = "Tek tek dosya seçimi, Taşı've'Bırak yok";
$lang['ionize_help_upload_mode_html5'] = "Taşı've'Bırak ile, çoklu dosya seçimi";
$lang['ionize_help_upload_autostart'] = "Dosya seçiminden sonra yklemeyi otomatik başlat";
$lang['ionize_label_api_key_hash'] = "Anahtar";
$lang['ionize_label_api_key_level'] = "Seviye";
$lang['ionize_label_api_key_is_private'] = "Gizlimi";
$lang['ionize_label_api_key_ignore_limits'] = "Sınırlama limiti";
$lang['ionize_label_api_key_ip_addresses'] = "IP Adresleri";
/*
|--------------------------------------------------------------------------
| Yönetici : Temalar
|--------------------------------------------------------------------------
...
$lang['ionize_label_online_in'] = 'Yayında';
...
$lang['ionize_help_home_page'] = 'Ana Sayfa';
$lang['ionize_label_page_used_by_module'] = 'Modül kullanılıyor';
$lang['ionize_help_page_used_by_module'] = 'Eğer işaretli ise, tüm alt bağlantılar bu modüle yönlendirilecek, ve bir 404 sayfası döndürmeyecek.';
$lang['ionize_label_sitemap_priority'] = 'Öncelik';
...
$lang['ionize_select_no_one'] = '-- Hiçbiri --';
...
$lang['ionize_help_page_view'] = 'Ortak sayfa görünümü';
$lang['ionize_help_page_type'] = 'Sayfa tipi (model)';
$lang['ionize_help_page_single_view'] = 'Bir makale görüntülemek için kullanılan sayfa görünümü';
...
$lang['ionize_help_article_template'] = 'Makaleleri bağımsız modda görüntülemek istiyorsanız ya da eğer sayfada sadece bir makale varsa';
...
$lang['ionize_help_sitemap_priority'] = 'Site Haritasında için sayfa Önceliği, 0 ile 10 arasında olmalıdır';
$lang['ionize_title_medias'] = 'Medyalar';
$lang['ionize_title_medialist'] = 'Medya Listesi';
$lang['ionize_title_thumbs_status'] = 'Küçük Resim Durumu';
$lang['ionize_title_informations'] = 'Bilgi';
$lang['ionize_title_details'] = 'Detaylar';
$lang['ionize_title_thumbnail'] = 'Küçük resim';
$lang['ionize_label_file_size'] = 'Dosya boyutu';
$lang['ionize_label_file_path'] = 'Yol';
...
$lang['ionize_label_delete_media'] = 'Medyayı Sil';
$lang['ionize_label_remove_media'] = 'Medyayı Kaldır';
...
$lang['ionize_label_add_video'] = 'Video bağlantısı ekle';
$lang['ionize_label_media_limit_display_to_lang'] = 'Görüntülemeyi Limitle';
$lang['ionize_label_media_display_limited_to_lang'] = 'Görüntüleme Limitlendi';
$lang['ionize_label_media_no_limit_display'] = 'Limit Yok';
$lang['ionize_button_add_video'] = 'Ekle';
...
$lang['ionize_button_list_view'] = 'Liste Görünümü';
$lang['ionize_button_card_view'] = 'Kart Görünümü';
$lang['ionize_button_save_media_data'] = 'Medya Bilgilerini Kaydet';
$lang['ionize_medialist_filter_by'] = '-- Filtrele --';
$lang['ionize_medialist_filter_by_alt_missing'] = 'ALT bilgisi olmayanlar';
$lang['ionize_medialist_filter_by_broken_src'] = 'Kaynağına ulaşılamayanlar';
$lang['ionize_medialist_filter_by_used_in_content'] = 'Saya / Makalede kullanılanlar';
$lang['ionize_medialist_filter_by_used_in_content_AL_missing'] = 'Sayfa / Makalede kullanılan ALT bilgisi olmayanlar';
$lang['ionize_medialist_filter_by_not_used'] = 'Kullanılmayanlar';
/*
|--------------------------------------------------------------------------
| Yönetici : Makale
|--------------------------------------------------------------------------
...
$lang['ionize_label_indexed'] = 'Aranabilir';
...
$lang['ionize_label_content_ok'] = 'İçerik Var';
$lang['ionize_label_content_missing'] = 'İçerik Bulunamadı';
...
$lang['ionize_label_new_lang'] = 'Yeni Dil Oluştur';
...
$lang['ionize_message_article_url_exists_in_page'] = 'Bu sayfada aynı URL ye sahip bir makale mevcut';
...
$lang['ionize_message_article_moved'] = 'Makale taşındı';
...
$lang['ionize_help_indexed'] = 'Eğer İşaretli ise, makale içerisindeki yazı FULLTEXT olarak indexlenecek (Site içi aramalar için)';
...
$lang['ionize_help_article_meta_description'] = 'Boş değilse ana açıklama yerine alacak';
$lang['ionize_help_article_meta_keywords'] = 'Boş değilse ana anahtar kelime yerini alacak';
$lang['ionize_button_duplicate_article'] = 'Makaleyi kopyala';
$lang['ionize_button_edit_mode'] = 'Düzenleme Modu';
$lang['ionize_button_full_mode'] = 'Tam Mod';
/*
|--------------------------------------------------------------------------
| Yönetici : Kategoriler, Tipler & Genişletilmiş Alanlar
|--------------------------------------------------------------------------
*/
...
$lang['ionize_label_category'] = 'Kategori';
$lang['ionize_label_edit_categories'] = 'Kategorileri düzenle';
$lang['ionize_label_edit_category'] = 'Kategoriyi düzenle';
$lang['ionize_label_new_category'] = 'Yeni bir kategori oluştur';
$lang['ionize_label_type'] = 'Tip';
...
$lang['ionize_message_category_name_exists'] = 'Bu kategori zaten var!';
...
$lang['ionize_label_extend_field_parent'] = 'Ana';
...
$lang['ionize_help_ef_values'] = 'değer:anahtar, satır sonu ile ayrılmış';
...
|--------------------------------------------------------------------------
*/
$lang['ionize_tab_current_theme'] = 'Şuanki Tema';
$lang['ionize_tab_modules'] = 'Modüller';
$lang['ionize_text_module_translation_file_exist_for'] = 'Varsayılan dillere ait modül dil dosyaları';
...
$lang['ionize_help_modules_translation'] = 'Modül için var olan statik çeviriler. <br/> Bu terimler tema viewinde şu şekilde kullanılabilir <dfn><\\ion:translation term="term" /></dfn>.<br/> Eğer değiştirmek veya çevirisini yazmak istiyorsanız, her çeviri için ait olduğu textarea ya çevirinizi ekleyin.';
/*
|--------------------------------------------------------------------------
| Yönetici : Medya yöneticisi
|--------------------------------------------------------------------------
*/
$lang['ionize_image_manager'] = 'Resimler';
$lang['ionize_file_manager'] = 'Dosyalar';
$lang['ionize_title_tree_browser'] = 'Bir elemente tıklayarak seçimi yapın...';
$lang['ionize_message_internal_link_not_found'] = 'Hata : İç bağlantı bulunamadı';
/*
|--------------------------------------------------------------------------
| Yönetici : Modüller
|--------------------------------------------------------------------------
...
$lang['ionize_message_module_install_error_no_config'] = 'Hata : Module without config.php';
...
$lang['ionize_title_check_element'] = 'İşaretli Elementler';
$lang['ionize_title_check_result'] = 'Sonuç';
$lang['ionize_title_check_status'] = 'Durum';
$lang['ionize_title_check_lang'] = 'Dilleri Kontrol Et';
$lang['ionize_title_check_folder'] = 'Klasör';
...
$lang['ionize_title_check_views'] = 'Görünümlerin kontrolü';
$lang['ionize_title_rebuild_urls'] = 'Bağlantıları tekrar oluştur';
$lang['ionize_title_rebuild_pages_urls'] = 'Sayfa URL leri yeniden oluşturuluyor';
$lang['ionize_title_rebuild_articles_urls'] = 'Makale URL leri yeniden oluşturuluyor';
$lang['ionize_title_clean_media'] = 'Medyaları temizle';
$lang['ionize_title_check_reports'] = 'Raporlar';
$lang['ionize_title_broken_media_links'] = 'Kırık medya bağlantıları';
$lang['ionize_title_delete_thumbs'] = 'Küçük resimleri sil';
$lang['ionize_text_rebuild_urls'] = 'Tüm sayfaların ve makalelerin bağlantılarını yeniden oluştur.<br/> Eski bağlantıları URL tablosundan kaldırır.';
$lang['ionize_text_check_lang'] = 'Veritabanında bulunan tüm dillerin config dosyasında olup olmadığını kontrol eder.<br/> Eğer gerekli ise confid dosyasını düzeltir.';
$lang['ionize_text_check_page_level'] = 'Sayfa düzenini kontrol eder ve gerekirse düzeltir.';
$lang['ionize_text_check_article_context'] = 'Makaleleri kontrol et, eğer makale bir sayfaya bağlıysa ve sayfa "Ana Dizin" ise.<br/>Eğer gerekli ise düzeltir.';
$lang['ionize_text_clean_media'] = 'Kullanılmayan medyaların bağlantılarını medya tablosundan siler. Medya dosyasını silmez.';
$lang['ionize_text_broken_media_links'] = 'Medya tablosundaki medya dosyaları (kullanılan) fakat serverda bulunamayan (eksik dosya).';
$lang['ionize_text_delete_thumbs'] = 'Tüm resimlerin ufaltılmış resimlerini sil. Küçük resimler sayfanız ziyaret edildiğinde tekrar oluşturulacak';
$lang['ionize_title_label_write_rights'] = 'Yazma doğru';
$lang['ionize_message_check_corrected'] = ' düzeltildi.';
$lang['ionize_message_check_ok'] = 'Herşey normal.';
$lang['ionize_message_check_folder_nok'] = 'Yazma izni yok';
$lang['ionize_message_message_no_write_rights'] = 'Yazma izni yok';
$lang['ionize_message_nb_media_cleaned'] = ' medyalar temizlendi';
...
|--------------------------------------------------------------------------
*/
$lang['ionize_label_about_us_author'] = 'Yazar';
$lang['ionize_label_about_us_contributors'] = 'Sanatçılar';
$lang['ionize_label_about_us_thaks_to'] = 'Teşekkürler';
$lang['ionize_label_about_us_license'] = 'Lisans';
/*
|--------------------------------------------------------------------------
| Ionize 1.0.0
|--------------------------------------------------------------------------
*/
$lang['ionize_title_roles'] = 'Roller';
$lang['ionize_title_permissions'] = 'İzinler';
$lang['ionize_title_backend_permissions'] = 'Yönetim Paneli İzinleri';
$lang['ionize_title_modules_permissions'] = 'Modül İzinleri';
$lang['ionize_label_role'] = 'Rol';
$lang['ionize_label_role_code'] = 'Rol Kodu';
$lang['ionize_label_role_name'] = 'Rol Adı';
$lang['ionize_label_role_level'] = 'Seviye';
$lang['ionize_title_role_edit'] = 'Rol Düzenle';
$lang['ionize_title_add_role'] = 'Yeni Rol Ekle';
$lang['ionize_title_add_user'] = 'Yeni Kullanıcı Ekle';
$lang['ionize_title_resource_protected'] = 'Kaynak korundu';
$lang['ionize_subtitle_resource_protected'] = "Kaynağa giriş izniniz yok.<br/>Eğer giriş yapmanız gerekiyorsa, üst seviye yönetici ile iletişim kurun.";
$lang['ionize_label_access_denied'] = 'Giriş Engellendi';
$lang['ionize_help_role_choice'] = 'Varolan Seviyeler:';
$lang['ionize_message_role_saved'] = 'Rol Kayıt Edildi';
$lang['ionize_message_role_deleted'] = 'Rol Silindi';
$lang['ionize_message_role_not_deleted'] = 'Rol Silinemedi';
$lang['ionize_label_back_to_role_list'] = 'Rol Listesine Geri Dön';
$lang['ionize_label_permissions_all'] = 'Hepsi';
$lang['ionize_label_permissions_custom'] = 'Özel';
$lang['ionize_label_allowed_resources'] = 'İzin Verildi';
$lang['ionize_label_allow'] = 'İzin Ver';
$lang['ionize_label_deny'] = 'Engelle';
$lang['ionize_label_partial_permission'] = 'kısmi';
$lang['ionize_label_permission_access'] = 'Giriş';
$lang['ionize_label_permission_edit'] = 'Düzenle';
$lang['ionize_label_permission_save'] = 'Kayıt Et';
$lang['ionize_label_permission_copy'] = 'Kopyala';
$lang['ionize_label_permission_move'] = 'Taşı';
$lang['ionize_label_permission_delete'] = 'Sil';
$lang['ionize_label_frontend'] = 'İnternet Sitesi';
$lang['ionize_label_backend'] = 'Yönetim Paneli';
$lang['ionize_label_behavior'] = 'Davranış';
$lang['ionize_label_can_see_backend'] = '(Yönetim Paneli)\'ni Görebilir';

$lang['ionize_label_denied_action_401'] = 'Giriş Yapılmalı (401)';
$lang['ionize_label_denied_action_403'] = 'Yasak (403)';
$lang['ionize_label_denied_action_404'] = 'Bulunamadı (404)';
$lang['ionize_help_denied_action_401'] = 'Sayfa menüde. Çıktı : 401, giriş yapılması gerekiyor';
$lang['ionize_help_denied_action_403'] = 'Sayfa menüde. Çıktı : 403, yasak içerik';
...
$lang['ionize_title_tags'] = "Etiketler";
$lang['ionize_label_new_tag'] = "Etiket Ekle";
$lang['ionize_button_save_tags'] = "Etiketleri Kayır Et";
$lang['ionize_button_add_tag'] = "Etiket Ekle";
$lang['ionize_help_tag_textbox'] = "etiketi buraya yazın";
...
$lang['ionize_ga_unique_pageviews'] = 'Benzersiz Sayfa Görünümleri';
$lang['ionize_ga_avg_time_on_page'] = 'Ortalama Sayfa Süresi';
$lang['ionize_ga_bounce_rate'] = 'Hemen Çıkma Oranı';
$lang['ionize_ga_exit_rate'] = 'Çıkış Oranı';
